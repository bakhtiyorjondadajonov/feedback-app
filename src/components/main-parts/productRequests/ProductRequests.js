...
function ProductRequestCard() {
  return (
    <Card>
     ...
     <p className="paragraph">It would help people with light sensitivities and who prefer dark mode.</p>
    ...
    <span className='number'>99</span></BtnUpvotes>
    <div className="category-container">
    <BtnCategory>Featured</BtnCategory>
    </div>
    </Card>
  )
}
