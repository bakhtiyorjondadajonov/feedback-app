...
sortProductReqs(data);
  ...
  return (
    <NavigationStyle >
       {
        props.logo && <div className="navigation__logo">
      ...
      {
props.roadmap && <div className="navigation__roadmap">
<Link style={{display:"flex",alignItems:"center",gap:"1rem"}} to="/"><ArrowLeft/> <span style={{color:"white",fontSize:"1.4rem",fontWeight:"700"}}>Go Back</span></Link>
<h2 className="roadmap-title">Roadmap</h2>
</div>
      }
      {
props.suggestions && <div className="navigation__suggestions">
...
<span>Suggestions</span>
      ...
      {
        props.sort && <div className="navigation__sort">
        <div>
          Sort by:
        </div>
        <span>
